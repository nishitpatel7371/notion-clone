            ...
            <div className="flex justify-between gap-4 items-center">
                ...
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    ...
                    <DialogContent className="sm:max-w-[450px]">
                        ...
                        <form className="grid gap-4 py-4">
                            <div className="grid grid-cols-4 items-center gap-4">
                                ...
                                <div className="flex items-center gap-4 col-span-3">
                                    <div
                                        className="w-18 h-16 aspect-square rounded-full overflow-hidden bg-muted flex items-center justify-center">
                                        {profilePicture ? (
                        ...
                        <DialogFooter>
                            <Button type="submit" onClick={() => setIsDialogOpen(false)}>Save Account</Button>
                        </DialogFooter>
                    </DialogContent>
                </Dialog>
            </div>
            <Table containerClassName={'max-h-[630px]'}>
                <TableHeader className={'sticky -top-1 bg-white'}>
                    <TableRow>
